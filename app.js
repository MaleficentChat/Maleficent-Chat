...
function openPublishNews(){
  ...
  modal(`<div class="publish-news-modal">
    ...
    <form id="newsForm">
      ...
      <textarea id="nb" rows="9" maxlength="3000" placeholder="Write your announcement…" required></textarea>
  ...
  $('newsForm').onsubmit=async e=>{
    ...
    try{
      await api('/api/news',{method:'POST',body:JSON.stringify({title,body})});
      closeModal();
      await loadNews();
